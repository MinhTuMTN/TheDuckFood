...
public class UserAccountAPI {
    ...
    public String payment(){
        UserAccount minhTu = userAccountRepository.findUserAccountByEmail("minhtu@gmail.com");
        UserAccount tuyetVi = userAccountRepository.findUserAccountByEmail("tuyetvi@gmail.com");

        tuyetVi.getUser().setBalance(tuyetVi.getUser().getBalance() + 50);
        userAccountRepository.save(tuyetVi);

        if (minhTu.getUser().getBalance() > 50){
            minhTu.getUser().setBalance(minhTu.getUser().getBalance() - 50);
            userAccountRepository.save(minhTu);
        } else {
